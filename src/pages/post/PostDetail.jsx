...
const PostDetail = (props) => {
    ...
    const [addCommnetBtnColor, setAddCommentBtnColor] = useState('#8a9f8f');
        ...
        <>
            ...
            <div id="post-detail-box">
                ...
                <svg viewBox="0 0 1200 200">
                    <path id="wave" d="M0 100 Q 150 50 300 100 T 600 100 T 900 100 T 1200 100 V 200 H 0 Z"></path>
                </svg>
